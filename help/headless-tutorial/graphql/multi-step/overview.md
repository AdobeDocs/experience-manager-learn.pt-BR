...
O código-fonte e os pacotes de conteúdo estão disponíveis na pasta `basic-tutorial` no [AEM Guides - Projeto GitHub do WKND GraphQL](https://github.com/adobe/aem-guides-wknd-graphql/tree/main/basic-tutorial).
