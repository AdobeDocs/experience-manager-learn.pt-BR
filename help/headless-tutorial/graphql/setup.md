...
Para permitir que o aplicativo React deste tutorial interaja com AEM endpoints da API GraphQL, uma configuração de compartilhamento de recursos entre origens é definida.
