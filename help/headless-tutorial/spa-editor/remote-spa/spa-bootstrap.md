...
Se ainda não tiver feito isso, baixe o código-fonte do aplicativo WKND pelo Github.com e alterne a ramificação que contém as alterações para o SPA executado neste tutorial.
