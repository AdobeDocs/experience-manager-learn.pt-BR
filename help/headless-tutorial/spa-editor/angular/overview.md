...
O que você está esperando?! Inicie o tutorial navegando até o capítulo [Projeto do editor de SPA](create-project.md) e saiba como gerar um projeto habilitado para o editor de SPA usando o Arquétipo de projeto AEM.
...
Ao gerar um novo projeto para uma implementação AEM, sempre use a versão mais recente do [Arquétipo de Projeto AEM](https://github.com/adobe/aem-project-archetype) e atualize o `aemVersion` para direcionar a versão pretendida do AEM.
