...
# Centro de conteúdo do AEM Assets

![Centro de conteúdo do AEM Assets](./assets/overview/hero.png){align=center}

Saiba como fazer upload de ativos, aplicar tags e entender o fluxo de trabalho de aprovação no Centro de conteúdo do Adobe Experience Manager Assets as a Cloud Service.

## Saiba mais sobre os recursos do Centro de conteúdo

Esses vídeos abordam os principais recursos do Centro de conteúdo do AEM Assets, desde o gerenciamento de ativos até a colaboração com sua equipe. Cada vídeo fornece etapas claras e dicas práticas para ajudar você a aproveitar ao máximo o Centro de conteúdo do AEM Assets no seu trabalho diário.
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/pt-br/docs/experience-manager-learn/assets/content-hub/set-up" title="Configurar" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3472940/?captions=por_br&format=jpeg&nocache=1759339176339" alt="Configurar"
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/pt-br/docs/experience-manager-learn/assets/content-hub/configure" title="Configurar" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3472951/?captions=por_br&format=jpeg&nocache=1759339176369" alt="Configurar"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/pt-br/docs/experience-manager-learn/assets/content-hub/add-assets" title="Adicionar ativos" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3445380/?captions=por_br&format=jpeg&nocache=1759339176806" alt="Adicionar ativos"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/pt-br/docs/experience-manager-learn/assets/content-hub/collections" title="Coleções" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3445305/?captions=por_br&format=jpeg&nocache=1759339176447" alt="Coleções"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/pt-br/docs/experience-manager-learn/assets/content-hub/share" title="Compartilhamento" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3474924/?captions=por_br&format=jpeg&nocache=1759339176327" alt="Compartilhamento"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="./attribute-based-access-control.md" title="Controle de acesso baseado em atributos" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3475419/?captions=por_br&format=jpeg&nocache=1759339175804" alt="Controle de acesso baseado em atributos"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
...
## Centro de conteúdo em ação

Explore casos de uso e cenários que demonstram como o Centro de conteúdo do AEM Assets pode ser usado com eficiência em vários contextos. Esses exemplos fornecem insights sobre as aplicações práticas do Centro de conteúdo, demonstrando sua versatilidade e capacidade de adaptação a diferentes necessidades de gerenciamento de ativos.
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="How to manage assets with AEM Assets Content Hub">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="./use-cases/manage-assets.md" title="Como gerenciar ativos com o Centro de conteúdo do AEM Assets" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3463061/?captions=por_br&format=jpeg&nocache=1759339177153" alt="Como gerenciar ativos com o Centro de conteúdo do AEM Assets"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="./use-cases/manage-assets.md" target="_blank" rel="referrer" title="Como gerenciar ativos com o Centro de conteúdo do AEM Assets">Como gerenciar ativos com o Centro de conteúdo do AEM Assets</a>
                    </p>
...
Confira a documentação do produto do Centro de conteúdo para ajudar a entender e usar completamente o Centro de conteúdo do AEM Assets. Esses recursos fornecem orientação detalhada sobre como usar seus recursos e funções, garantindo que você tenha o suporte necessário para o gerenciamento de ativos eficiente.
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Content Hub documentation">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/pt-br/docs/experience-manager-cloud-service/content/assets/content-hub/product-overview" target="_blank" rel="referrer" title="Documentação do Centro de conteúdo">Documentação do Centro de conteúdo</a>
                    </p>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Deploy Content Hub">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/pt-br/docs/experience-manager-cloud-service/content/assets/content-hub/deploy-content-hub" target="_blank" rel="referrer" title="Implantar o Centro de conteúdo">Implantar o Centro de conteúdo</a>
                    </p>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Content Hub FAQs">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/pt-br/docs/experience-manager-cloud-service/content/assets/content-hub/frequently-asked-questions-content-hub" target="_blank" rel="referrer" title="Perguntas frequentes do Centro de conteúdo">Perguntas frequentes do Centro de conteúdo</a>
                    </p>
