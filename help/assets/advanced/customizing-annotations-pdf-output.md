...
O AEM permite a personalização da saída da anotação para o PDF.

## sling de anotação do PDF:definição OsgiConfig

Para personalizar anotações do PDF, crie um nó **sling:OsgiConfig** no seu projeto do AEM em
