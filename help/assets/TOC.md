...
+ Playlists de vídeo{#video-playlists}
   + [Visualização de ativos](playlists/assets-view.md)
...
+ Recursos avançados{#advanced}
   ...
   + [Saída de anotações em PDF](./advanced/customizing-annotations-pdf-output.md)
   ...
   + [Upload de ativo programático](./advanced/programmatic-asset-upload.md)
...
+ Centro de conteúdo{#content-hub}
   ...
   + [Controle de acesso baseado em atributos](./content-hub/attribute-based-access-control.md)
...
+ Adobe GenStudio{#adobe-genstudio}
   + [AEM Assets e GenStudio para Marketing de desempenho](https://experienceleague.adobe.com/pt-br/docs/integrations-learn/experience-cloud/tutorials/genstudio-for-performance-marketing-experience-manager/overview)
...
+ Compartilhamento e distribuição{#sharing}
   ...
   + Brand Portal{#brand-portal}
      ...
      + [Habilitar downloads de representação](brand-portal/enable-renditions-download.md)
   ...
   + Compartilhamento de ativos{#assets-share}
      ...
      + [Definição de temas no Asset Share Commons](./sharing/asset-share-commons-feature-video-theming.md)
...
+ Automação de conteúdo{#content-automation}
   ...
   + [Operação criativas](./content-automation/creative-operations.md)
...
+ Dynamic Media{#dynamic-media}
   ...
   + Vídeo {#video}
      + [Práticas recomendadas](dynamic-media/dynamic-media-video-best-practices.md)
      ...
      + [Vídeo de corte inteligente do Dynamic Media](dynamic-media/dynamic-media-smart-crop-video.md)
      + [Reprodutor de vídeo](dynamic-media/dynamic-media-video-player-feature-video-use.md)
   + Visualizadores {#viewers}
      + [Visualizadores](dynamic-media/dynamic-media-viewer-feature-video-understand.md)
   ...
   + Utilização com o AEM Sites {#dm-with-aem-sites}
...
+ Integração com o Workfront{#workfront}
   + Conector aprimorado{#enhanced-connector}
      ...
      + [Páginas do projeto](./workfront/enhanced-connector/project-folders.md)
...
+ Tradução {#translation}
   + [Tradução de arquivo de origem](translation/source-file-translation-feature-video-use.md)
...
+ Modelos de ativos{#asset-templates}
   ...
   + [Utilização de modelos de ativos](asset-templates/asset-templates-feature-video-use.md)
   + [Configurar modelos de ativos](asset-templates/asset-templates-technical-video-setup.md)
   + [Utilização de catálogos de ativos](asset-templates/asset-catalog-template-feature-video-use.md)
