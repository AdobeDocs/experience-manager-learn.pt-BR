...
description: Os perfis de metadados permitem a aplicação automática de metadados padrão em ativos nas pastas de ativos, ajudando a reduzir a carga do gerenciamento de metadados sobre os usuários do AEM e aumentando a consistência dos metadados.
feature: Metadata
