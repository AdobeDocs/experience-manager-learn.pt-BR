---
title: Práticas recomendadas do visualizador e do vídeo do Dynamic Media
description: Saiba mais sobre as práticas recomendadas para publicação e otimização de vídeo no AEM Dynamic Media, incluindo transmissão adaptável, recorte inteligente para diferentes tamanhos de tela, predefinições do visualizador personalizado e suporte para legendas, faixas de áudio e marcadores de capítulo.
...
# Práticas recomendadas do visualizador e do vídeo do Dynamic Media
