...
>[!TIP]
>
> Saiba mais sobre como a variável [Programa de treinamento Adobe XD Premium](https://spark.adobe.com/page/wU7OXv8qKGugO/) O pode ajudar a integrar o Asset Link ao seu fluxo de trabalho do Adobe Experience Manager.
...
1. AEM Manipulador de autenticação do portador extrai o token do portador da solicitação e o valida com o Adobe IMS.
