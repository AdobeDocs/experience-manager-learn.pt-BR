...
5. A invalidação de cache se torna muito fácil e determinística nessa configuração. Como apenas um sistema Publish está conectado a uma Dispatcher, há apenas uma Dispatcher para invalidar. A ordem e o momento da invalidação são triviais.
