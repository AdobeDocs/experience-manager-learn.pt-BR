...
description: No segundo vídeo que aborda a migração de conteúdo, James e Darin discutem o uso da ferramenta Transferência de conteúdo (CTT) para auxiliar na migração para o AEM as a Cloud Service.
...
No segundo vídeo que aborda a migração de conteúdo, James e Darin discutem o uso da ferramenta Transferência de conteúdo (CTT) para auxiliar na migração para o AEM as a Cloud Service.
