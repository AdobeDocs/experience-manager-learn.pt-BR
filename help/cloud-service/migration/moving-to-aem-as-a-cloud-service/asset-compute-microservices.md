...
Como parte da refatoração de sua base de código, use a [ferramenta de Migração de Fluxo de Trabalho de Ativos](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/moving/refactoring-tools/asset-workflow-migration-tool.html?lang=pt-BR) para migrar fluxos de trabalho existentes e usar os microsserviços do Asset Compute no AEM as a Cloud Service.

## Atividades principais

+ Use a ferramenta [Adobe I/O Workflow Migrator](https://github.com/adobe/aio-cli-plugin-aem-cloud-service-migration#command-aio-aem-migrationworkflow-migrator) para migrar fluxos de trabalho de processamento de ativos para usar os microsserviços do Asset Compute.
