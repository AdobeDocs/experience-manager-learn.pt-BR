...
Personalização de experiência em ação no [site de Habilitação do WKND](https://wknd.enablementadobe.com/us/en.html){target="wknd"}. O site de demonstração demonstra três tipos de personalização: teste A/B, direcionamento comportamental e personalização de usuário conhecido.
