...
+ Implantar em [AEM ambientes de desenvolvimento rápido](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/rde/overview.html)
...
### Configurar o plug-in AEM Rapid Development Environment{#rde}

O plug-in AEM Rapid Development Environment permite que a CLI do aio interaja com AEM as a Cloud Service [Ambientes de desenvolvimento rápido](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/rde/overview.html) através da `aio aem:rde` comando.

1. Executar `aio plugins:install @adobe/aio-cli-plugin-aem-rde` para instalar o [Plug-in de ambientes de desenvolvimento rápido AEM](https://github.com/adobe/aio-cli-plugin-aem-rde).
