...
+ APIs AEM{#aem-apis}
   ...
   + [APIs AEM baseadas em OpenAPI (servidor para servidor)](./apis/invoke-openapi-based-aem-apis.md)
   + [APIs AEM baseadas em OpenAPI (autenticadas pelo usuário)](./apis/invoke-openapi-based-aem-apis-from-web-app.md)
