...
Verifique se a variável [endereço IP de saída dedicado ou VPN](../advanced-networking.md#advanced-networking) a configuração avançada de rede foi configurada antes de seguir este tutorial.
