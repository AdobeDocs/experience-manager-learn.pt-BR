...
O Adobe Acrobat Sign (antigo Acrobat Sign) permite fluxos de trabalho de assinatura eletrônica para formulários adaptáveis do AEM Forms, melhorando os fluxos de trabalho para processar documentos para áreas legais, de vendas, folha de pagamento, HR e outras.
...
+ [Guia do usuário de Conteúdo e Comércio AEM](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/content-and-commerce/home.html?lang=pt-BR)
...
+ AEM Assets Essentials
   ...
   + [Vídeos do Adobe Workfront e Assets Essentials](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/workfront/configure.html?lang=pt-BR)
