...
- Crie um novo repositório Git do Cloud Manager para o projeto do WKND Sites e adicione-o como remoto ao seu repositório Git local:
   ...
   - Insira um **Nome do Repositório** (por exemplo, &quot;wknd-site-tutorial&quot;) e clique em **Salvar**. Aguarde a criação do repositório.
     ...
     ![Adicionar repositório](./assets/development-agent-troubleshoot-ci-cd-pipeline/add-repository.png)

   - Clique em **Acessar informações do repositório** no canto superior direito e copie a URL do repositório.

     ![Acessar informações do repositório](./assets/development-agent-troubleshoot-ci-cd-pipeline/access-repo-info.png)
...
- Na caixa de diálogo **Adicionar pipeline de não produção**, configure o seguinte:
   ...
   - Etapa de **configuração**:
     ...
     ![Adicionar configuração de pipeline de não produção](./assets/development-agent-troubleshoot-ci-cd-pipeline/add-non-production-pipeline-configuration.png)
   ...
   - **Código Source** etapa:
     ...
     ![Adicionar código Source de não produção do pipeline](./assets/development-agent-troubleshoot-ci-cd-pipeline/add-non-production-pipeline-source-code.png)
...
- Execute o pipeline de Qualidade de Código recém-criado clicando em **Executar** no menu de três pontos da entrada do pipeline.
  ...
  ![Executar Pipeline de Qualidade de Código](./assets/development-agent-troubleshoot-ci-cd-pipeline/run-code-quality-pipeline.png)
...
![Falha na execução do pipeline](./assets/development-agent-troubleshoot-ci-cd-pipeline/failed-pipeline-execution.png)
...
- Insira os detalhes de falha do pipeline em linguagem natural também conhecida como **Prompt**. Por exemplo:
  ...
  ![Invocar Agente de Desenvolvimento do AEM](./assets/development-agent-troubleshoot-ci-cd-pipeline/invoke-aem-development-agent.png)
...
- Quando o raciocínio estiver concluído, clique no ícone **Abrir em tela cheia** para exibir o processo detalhado de solução de problemas.
  ...
  ![Abrir em tela inteira](./assets/development-agent-troubleshoot-ci-cd-pipeline/open-in-full-screen.png)
...
- Nesse caso, o agente sugeriu corretamente a alteração da implementação (método `getName()`) ou a atualização do teste de unidade (método `getNameTest()`) para corrigir o problema. Ele evitava alucinações e usava uma abordagem de &quot;humano no loop&quot; ao fornecer alterações de código acionáveis para o desenvolvedor.
  ...
  ![Copiar alterações de código](./assets/development-agent-troubleshoot-ci-cd-pipeline/copy-code-changes.png)
...
![Comparar ramificações](./assets/development-agent-troubleshoot-ci-cd-pipeline/compare-branches.png)
