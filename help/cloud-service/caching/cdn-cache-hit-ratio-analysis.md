...
Para este tutorial, a variável [Projeto WKND do AEM](https://github.com/adobe/aem-guides-wknd) é implantado no ambiente as a Cloud Service AEM e um pequeno teste de desempenho é acionado usando [Apache JMeter](https://jmeter.apache.org/).
...
Para analisar os logs de CDN, este artigo usa o **Elasticsearch, Logstash e Kibana (ELK)** [ferramentas do painel](https://github.com/adobe/AEMCS-CDN-Log-Analysis-ELK-Tool) e [Jupyter Notebook](https://jupyter.org/).


### Usar ferramentas do painel
...
A variável [Jupyter Notebook](https://jupyter.org/) O é um aplicativo web de código aberto que permite criar documentos com código, texto e visualização. Ele é usado para transformação de dados, visualização e modelagem estatística.

Para acelerar a análise de registros CDN, baixe o [AEM-as-a-CloudService - Análise de registros CDN - Jupyter Notebook](./assets/cdn-logs-analysis/aemcs_cdn_logs_analysis.ipynb) arquivo.
...
#### Execute o Jupyter Notebook no Experience Platform

>[!IMPORTANT]
>
>Se você estiver usando ou licenciando o Experience Platform, poderá executar o Jupyter Notebook sem instalar software adicional.

Para executar o Jupyter Notebook no Experience Platform, siga estas etapas:
...
## Otimizar a configuração do cache da CDN
