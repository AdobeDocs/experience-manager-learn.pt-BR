...
Os registros em AEM as a Cloud Service têm vários pods gravando declarações de log neles. Como várias instâncias de AEM são gravadas no mesmo arquivo de log, é importante entender como analisar e reduzir o ruído durante a depuração. Para explicar, faça o seguinte `aemerror` snippet de log é usado:
