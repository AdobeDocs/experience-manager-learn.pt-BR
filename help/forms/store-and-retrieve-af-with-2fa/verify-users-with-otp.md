...
Para integrar o AEM/AEM Forms com aplicativos de terceiros, precisamos [REST based data source usando o arquivo swagger](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/ic-web-channel-tutorial/parttwo.html) na configuração dos serviços de nuvem. A fonte de dados completa é fornecida a você como parte dos ativos do curso.
