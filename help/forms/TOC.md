...
+ Criando seu primeiro formulário adaptável {#creating-your-first-adaptive-form}
   ...
   + [Adicionar componentes ao painel Gente](creating-your-first-adaptive-form/adding-components-to-people-panel.md)
...
+ Formulários adaptáveis {#adaptive-forms}
   ...
   + [Envio personalizado no Forms adaptável](adaptive-forms/custom-submit-aem-forms-article.md)
   + [Captcha no Forms adaptável](adaptive-forms/forms-captcha-feature-video-use.md)
   + [Uso do Definir valor em XML no fluxo de trabalho OSGI](adaptive-forms/setvalue-aem-forms-workflow-tutorial-use.md)
   + [Usando Definir valor em JSON no fluxo de trabalho OSGI](adaptive-forms/setvalue-json-data-in-aem-forms-workflow-article-use.md)
   + [Enviar componente de e-mail no AEM Forms Workflow](adaptive-forms/email-step-aem-workflow-video-use.md)
   + [Geração de DocumentOfRecord usando a API](adaptive-forms/document-of-record-api-tutorial-use.md)
   + [Exibição de imagens em linha](adaptive-forms/inline-images-adaptive-forms.md)
   + [Uso da API GeoLocation](adaptive-forms/using-geolocation-api-in-aem-forms-article.md)
   + [Usando o Relatórios de Transação](adaptive-forms/transaction-reporting-aem-forms-article-use.md)
   + [Integração de dados de Perfil do usuário no AEM Forms](adaptive-forms/user-profile-data-integration-feature-video-use.md)
   ...
   + [Uso do usuário do serviço no AEM Forms](adaptive-forms/service-user-tutorial-develop.md)
   + [Marcação e armazenamento do DoR no envio de formulário adaptável](adaptive-forms/tagging-and-saving-document-of-record-in-dam-article-use.md)
   + [Preenchendo tabela com os resultados da Invocação do Serviço de Modelo de Dados de Formulário](adaptive-forms/populatetable.md)
   ...
   + [Etapa do serviço Tratamento de mensagens de erro no Modelo de dados de formulário](adaptive-forms/handling-error-messages-in-invoke-fdm-step.md)
   ...
   + [Fluxo de trabalho AEM Etapa do Processo Personalizado](adaptive-forms/custom-process-step-aem-workflow.md)
...
+ Preenchimento de formulário adaptável usando o modelo de dados de formulário{#prefill-fdm-db}
...
+ Armazenar e recuperar formulário adaptável{#store-and-retrieve-af-with-2fa}
   ...
   + [Armazenar dados de formulário](store-and-retrieve-af-with-2fa/store-form-data.md)
...
+ Formulários HTML5{#html5-forms}
   ...
   + [Processar envio de formulário HTML5](html5-forms/handle-html5-form-submission.md)
+ AEM Forms e Adobe Sign{#forms-and-sign}
   ...
   + [Criar aplicativo da API Adobe Sign](aem-forms-and-adobe-sign/create-adobe-sign-api-application.md)
   + [Criar configuração da Adobe Sign Cloud](aem-forms-and-adobe-sign/create-adobe-sign-cloud-configuration.md)
   + [Criar fluxo de trabalho para enviar documentos para assinatura](aem-forms-and-adobe-sign/create-workflow-to-send-document-for-signing.md)
   + [Criar e configurar formulário adaptável](aem-forms-and-adobe-sign/create-and-configure-adaptive-form.md)
   + [Configurar formulário adaptável para um único assinante](aem-forms-and-adobe-sign/configure-adaptive-form-for-single-signer.md)
   ...
   + [Configurar o serviço de Automated forms conversion](aem-forms-and-adobe-sign/configure-automated-forms-conversion-service.md)
...
+ Acionando AEM fluxo de trabalho a partir do envio do formulário móvel{#offline-mobile-form-submission}
   ...
   + [Implantar em seu sistema](offline-mobile-form-submission/part-four.md)
+ Consultando dados enviados{#querying-submitted-data}
   + [Introdução](querying-submitted-data/introduction.md)
   + [Criar formulário com base no Schema JSON](querying-submitted-data/part1.md)
   + [Armazenar os dados enviados](querying-submitted-data/part2.md)
   + [Armazenar o Schema JSON](querying-submitted-data/part3.md)
   + [Query dos dados enviados](querying-submitted-data/part4.md)
...
+ AEM Forms com Marketo{#aem-forms-with-marketo}
   ...
   + [Parte 4 - Unir tudo](aem-forms-with-marketo/part4.md)
...
+ AEM Forms com Adobe Campaign Standard{#aem-forms-with-adobe-campaign}
   ...
   + [Parte 2 - Criação de Perfis ACS no envio de formulário](aem-forms-with-adobe-campaign/parttwo.md)
...
+ Serviços de documentação {#document-services}
   ...
   + [Usando o serviço de saída e Forms no AEM Forms](document-services/output-and-forms-services-article-develop.md)
   ...
   + [Aplicar direitos de uso a PDF na execução XDP](document-services/rendering-and-reader-extending-xdp-templates-article.md)
...
+ Comunicações interativas {#interactive-communications}
   ...
   + [Usando funções de redutor](interactive-communications/reducer-functions-in-charts-aem-forms-video-use.md)
   + [Layout de duas colunas em Documentos de Canais de impressão](interactive-communications/two-column-layout-aem-forms-article-use.md)
...
+ Interative Communications For Web Canal {#ic-web-channel-tutorial}
   ...
   + [Criando Modelo de Documento de Canais da Web](ic-web-channel-tutorial/partfour.md)
   + [Criação de fragmento de Documento](ic-web-channel-tutorial/partfive.md)
   + [Criando Documento de comunicação interativa](ic-web-channel-tutorial/partsix.md)
   + [Adicionar texto e imagens](ic-web-channel-tutorial/partseven.md)
   ...
   + [Configurando Gráfico de Colunas](ic-web-channel-tutorial/partten.md)
   + [Configuração do Gráfico de Pizza](ic-web-channel-tutorial/parteleven.md)
   + [Delivery Do Documento Canal Da Web](ic-web-channel-tutorial/parttwelve.md)
   + [Delivery de e-mail do Documento de Canal da Web](interactive-communications/delivery-of-web-channel-document-tutorial-use.md)
