...
+ Criar o primeiro formulário adaptável {#creating-your-first-adaptive-form}
   ...
   + [5 - Configuração do painel raiz e adição de painéis filhos](creating-your-first-adaptive-form/configuring-root-panel-and-adding-child-panels.md)
   + [6 - Adicionar componentes ao painel Pessoas](creating-your-first-adaptive-form/adding-components-to-people-panel.md)
   + [7 - Adicionar tabela ao painel de renda](creating-your-first-adaptive-form/adding-table-to-income-panel.md)
   + [8 - Configuração do painel Ativos](creating-your-first-adaptive-form/configuring-assets-panel.md)
   + [9 - Uso de funções personalizadas e do editor de códigos](creating-your-first-adaptive-form/using-custom-functions-and-code-editor.md)
...
+ Formulários adaptáveis {#adaptive-forms}
   ...
   + [Exibição em linha de imagens do DAM](adaptive-forms/inline-images-from-dam.md)
   + [Uso da API da GeoLocation](adaptive-forms/using-geolocation-api-in-aem-forms-article.md)
   ...
   + [Teste Automatizado Do Adaptive Forms](adaptive-forms/calvin-sdk-test-adaptive-forms-feature-video.md)
...
+ Armazenamento e recuperação do formulário adaptável{#store-and-retrieve-af-with-2fa}
   ...
   + [10 - Criar o formulário da minha conta](store-and-retrieve-af-with-2fa/create-the-myaccount-form.md)
...
+ AEM Forms e Acrobat Sign{#forms-and-sign}
   ...
   + [Criar configuração da Acrobat Sign Cloud](aem-forms-and-adobe-sign/create-adobe-sign-cloud-configuration.md)
   ...
   + [Uso de modelos XDP com Acrobat Sign](aem-forms-and-adobe-sign/using-xdp-templates-with-adobe-sign.md)
+ Assinar várias Forms{#sign-multiple-documents}
   ...
   + [5 - Atualizar fluxo de trabalho do status da assinatura](sign-multiple-documents/update-signature-status.md)
...
+ Componente de fluxo de trabalho personalizado{#custom-workflow-component}
   ...
   + [Código java de 2 gravações](custom-workflow-component/custom-process-step-aem-workflow.md)
...
+ AEM Forms com Adobe Campaign Standard{#aem-forms-with-adobe-campaign}
   ...
   + [3 - Criação do perfil ACS no envio do formulário](aem-forms-with-adobe-campaign/parttwo.md)
   + [4 - Preenchimento prévio do formulário usando as informações de perfil do ACS](aem-forms-with-adobe-campaign/partthree.md)
   + [5 - Criar perfil ACS usando o Modelo de dados de formulário](aem-forms-with-adobe-campaign/partfour.md)
...
+ Incorporar formulários adaptáveis ao SPA {#embed-form-spa}
...
+ Aplicativo React com Forms e Acrobat Sign {#react-ic-sign}
   ...
   + [3 - Wrapper de API do Acrobat Sign](react-ic-sign/wrapper-sign-api.md)
   + [4 - Gerar widget de sinal](react-ic-sign/create-servlet-to-expose-endpoint.md)
...
{#ic-print-channel-tutorial}
   ...
   + [7 - Criar documento de canal de impressão](ic-print-channel-tutorial/create-print-channel-document.md)
   + [8 - Adicionar conteúdo às áreas de destino](ic-print-channel-tutorial/add-content-to-target-areas.md)
   + [9 - Configurando o Gráfico de Linha](ic-print-channel-tutorial/configuring-line-chart.md)
   + [10 - Adição da tabela ao canal de impressão](ic-print-channel-tutorial/adding-table-to-print-channel.md)
   + [11 - Usar a pasta assistida para gerar documentos](ic-print-channel-tutorial/using-watched-folder-to-generate-document.md)
   + [12 - Abrir a interface do usuário do agente no envio de formulário](ic-print-channel-tutorial/opening-agent-ui-on-form-submission.md)
...
+ Comunicações Interativas Para Canal Da Web {#ic-web-channel-tutorial}
   ...
   + [6 - Criação do fragmento do documento](ic-web-channel-tutorial/partfive.md)
   + [7 - Criando Documento de Comunicação Interativa](ic-web-channel-tutorial/partsix.md)
   ...
   + [10 - Configuração da tabela](ic-web-channel-tutorial/partnine.md)
   ...
   + [13 - Delivery Do Documento Do Canal Da Web](ic-web-channel-tutorial/parttwelve.md)
...
+ Resolução de problemas {#troubleshooting}
   ...
   + [Habilitar mesclagem de arquivos de dados xml grandes com modelo](troubleshooting/fix-timeout-errors-when-merging-large-xml-wth-template.md)
