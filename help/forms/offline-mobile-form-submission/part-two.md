...
## Servlet de autor de AEM

A próxima etapa é armazenar os dados enviados no repositório do autor de AEM. O servlet montado em `/bin/startworkflow` salva os dados enviados.
