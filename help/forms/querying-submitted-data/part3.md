...
Para consultar os dados enviados, é necessário armazenar o esquema JSON associado ao formulário enviado. O esquema JSON é usado no construtor de consultas para criar a consulta.
