...
Os recursos associados a este artigo permitirão arrastar e soltar documentos do MS Office ou arquivo JPG na área de soltar da página HTML. Depois que o documento é descartado, ele chama o serviço PDFG e converte o documento em PDF e o salva no sistema de arquivos do AEM Server.
