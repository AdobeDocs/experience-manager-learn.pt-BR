...
+ Fragmentos de experiência {#experience-fragments}
   ...
   + [Configurar a publicação do Social com fragmentos de experiência](experience-fragments/experience-fragments-social-technical-video-setup.md)
...
+ Integrações {#integrations}
   + Experience Platform Launch {#experience-platform-launch}
      ...
      + [Conectar o AEM com o Launch usando o Adobe I/O](integrations/experience-platform-launch/connect-aem-launch-adobe-io.md)
      + [Criar um serviço do Launch Cloud](integrations/experience-platform-launch/create-launch-cloud-service.md)
      + [Depuração de uma implementação do Launch](integrations/experience-platform-launch/debug-launch-implementation.md)
   + Camada de dados do cliente da Adobe {#adobe-client-data-layer}
      + [Uso da camada de dados do cliente da Adobe](integrations/adobe-client-data-layer/data-layer-overview.md)
