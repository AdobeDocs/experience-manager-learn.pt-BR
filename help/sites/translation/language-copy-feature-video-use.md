...
Com o aprimoramento da tradução do site do Assistente de criação de cópia de idioma do AEM 6.3, os usuários podem criar uma cópia de idioma a partir do idioma mestre sem precisar criar uma página raiz.
