...
description: Saiba como tornar os sites mais rápidos com o Edge Delivery Services.
...
>[!VIDEO](https://video.tv.adobe.com/v/3453452/?captions=por_br&learn=on)
...
<div class="columns">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/pt-br/docs/experience-manager-cloud-service/content/edge-delivery/build/tutorial" target="_blank" rel="referrer" title="Tutorial da criação baseada em documentos e do Edge Delivery Services">Tutorial da criação baseada em documentos e do Edge Delivery Services</a>
                    </p>
                    <p class="is-size-6">Saiba como criar sites do Edge Delivery Services com a criação baseada em documentos.</p>
                </div>
                <a href="https://experienceleague.adobe.com/pt-br/docs/experience-manager-cloud-service/content/edge-delivery/build/tutorial" target="_blank" rel="referrer" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Universal Editor and Edge Delivery Services tutorial">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="./developing/universal-editor/0-overview.md" title="Tutorial do editor universal e do Edge Delivery Services" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="developing/universal-editor/assets/0-overview/hero.png" alt="Tutorial do editor universal e do Edge Delivery Services"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="./developing/universal-editor/0-overview.md" target="_blank" rel="referrer" title="Tutorial do editor universal e do Edge Delivery Services">Tutorial do editor universal e do Edge Delivery Services</a>
                    </p>
                    <p class="is-size-6">Conheça os princípios básicos da criação de sites do Edge Delivery Services com o editor universal.</p>
                </div>
      ...
      <div class="card">
        <div class="card-image">
          <figure class="image is-16by9">
            <a href="./developing/prerequisites.md" title="Pré-requisitos"
              tabindex="-1">
              <img class="is-bordered-r-small"
                src="https://video.tv.adobe.com/v/3434589/?captions=por_br&format=jpeg"
                alt="Pré-requisitos">
            </a>
          </figure>
        </div>
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">O que é necessário para começar a desenvolver com o Edge Delivery Services.</p>
      ...
      <div class="card">
        <div class="card-image">
          <figure class="image is-16by9">
            <a href="./developing/aem-boilerplate.md" title="Usar modelo padrão"
              tabindex="-1">
              <img class="is-bordered-r-small"
                src="https://video.tv.adobe.com/v/3434616/?captions=por_br&format=jpeg" alt="Configurar
                padrão">
            </a>
          </figure>
        </div>
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="headline is-size-6 has-text-weight-bold">
              <a href="./developing/aem-boilerplate.md" title="Usar modelo padrão">Padrão do AEM</a>
            </p>
            <p class="is-size-6">Use o modelo padrão do AEM para configurar o repositório de códigos.</p>
        ...
        <div class="card-image">
          <figure class="image is-16by9">
            <a href="./developing/content-repository.md" title="Vincular Google Drive"
              tabindex="-1">
              <img class="is-bordered-r-small"
                src="https://video.tv.adobe.com/v/3434725/?captions=por_br&format=jpeg" alt="Vincular Google Drive">
            </a>
          </figure>
        </div>
        <div class="card-content is-padded-small">
      ...
      <div class="card">
        <div class="card-image">
          <figure class="image is-16by9">
            <a href="./developing/content-repository.md" title="Vincular SharePoint" tabindex="-1">
              <img class="is-bordered-r-small"
                src="https://video.tv.adobe.com/v/3446033/?captions=por_br&format=jpeg"
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">Use o SharePoint como repositório para todo o seu conteúdo.</p>
        ...
        <div class="card-image">
          <figure class="image is-16by9">
            <a href="./developing/preview-and-publish.md" title="Visualizar e publicar conteúdo"
              tabindex="-1">
              <img class="is-bordered-r-small"
                src="https://video.tv.adobe.com/v/3434714/?captions=por_br&format=jpeg" alt="Visualizar e publicar conteúdo">
            </a>
          </figure>
        </div>
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">Visualizar e publicar conteúdo com o AEM Sidekick.</p>
        ...
        <div class="card-image">
          <figure class="image is-16by9">
            <a href="./developing/sidekick.md" title="Usar o Sidekick"
              tabindex="-1">
              <img class="is-bordered-r-small"
                src="https://video.tv.adobe.com/v/3441291/?captions=por_br&format=jpeg"
                alt="Usar o Sidekick">
            </a>
          </figure>
        </div>
        <div class="card-content is-padded-small">
          <div class="content">
            <p style="float: right;font-style: italic; color: #363636"
              class="is-size-6">Um minuto</p>
            <p class="headline is-size-6 has-text-weight-bold">
              <a href="./developing/sidekick.md" title="Usar o Sidekick">Usar o AEM Sidekick</a>
            </p>
            <p class="is-size-6">Saiba como usar o AEM Sidekick.</p>
      ...
      <div class="card">
        <div class="card-image">
          <figure class="image is-16by9">
            <a href="./developing/document-structure.md" title="Estrutura do documento"
              tabindex="-1">
              <img class="is-bordered-r-small"
                src="https://video.tv.adobe.com/v/3445194/?captions=por_br&format=jpeg"
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">Explorar a estrutura do documento, incluindo o conteúdo, as seções e os blocos padrão </p>
      ...
      <div class="card">
        <div class="card-image">
          <figure class="image is-16by9">
            <a href="./developing/local-development.md" title="Desenvolvimento local"
              tabindex="-1">
              <img class="is-bordered-r-small"
                src="https://video.tv.adobe.com/v/3434736/?captions=por_br&format=jpeg"
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">Configurar o ambiente de desenvolvimento local.</p>
      ...
      <div class="card">
        <div class="card-image">
          <figure class="image is-16by9">
            <a href="./developing/git.md" title="Integrar ao Git"
              tabindex="-1">
              <img class="is-bordered-r-small"
                src="https://video.tv.adobe.com/v/3441831/?captions=por_br&format=jpeg"
                alt="Integrar ao Git">
            </a>
          </figure>
        </div>
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">Configurar o Git e o Edge Delivery Services.</p>
      ...
      <div class="card">
        <div class="card-image">
          <figure class="image is-16by9">
            <a href="./how-to/rss.md" title="Criar feeds RSS"
              tabindex="-1">
              <img class="is-bordered-r-small"
                src="https://video.tv.adobe.com/v/3438004/?captions=por_br&format=jpeg"
                alt="Criar feeds RSS">
            </a>
          </figure>
        </div>
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">Saiba como criar feeds RSS.</p>
      ...
      <div class="card">
        <div class="card-image">
          <figure class="image is-16by9">
            <a href="./how-to/social-media-sharing.md" title="Compartilhamento em redes sociais"
              tabindex="-1">
              <img class="is-bordered-r-small"
                src="https://video.tv.adobe.com/v/3439442/?captions=por_br&format=jpeg"
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">Saiba como otimizar o seu conteúdo para compartilhamento em redes sociais.</p>
        ...
        <div class="card-image">
          <figure class="image is-16by9">
            <a href="./how-to/delete-page.md" title="Excluir páginas"
              tabindex="-1">
              <img class="is-bordered-r-small"
                src="https://video.tv.adobe.com/v/3438095/?captions=por_br&format=jpeg"
                alt="Excluir páginas">
            </a>
          </figure>
        </div>
