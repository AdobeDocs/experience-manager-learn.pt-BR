...
description: Saiba como agilizar os sites com o Edge Delivery.
...
Saiba como agilizar os sites com o Edge Delivery

Revise o [documentação](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/edge-delivery/overview.html) para obter detalhes completos sobre o Edge Delivery e seus recursos.
...
<div class="columns is-multiline">
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen"
      ...
      <div class="card">
        <div class="card-image">
          <figure class="image is-16by9">
            <a href="./developing/prerequisites.md" title="Instalar nó"
              tabindex="-1">
              <img class="is-bordered-r-small"
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="headline is-size-6 has-text-weight-bold">
              <a href="./developing/prerequisites.md" title="Instalar nó">Instalar nó</a>
            </p>
            <p class="is-size-6">Uma breve visão geral de como instalar o Node JS.</p>
            <a href="./developing/prerequisites.md" class="spectrum-Button
              spectrum-Button--outline spectrum-Button--primary
              spectrum-Button--sizeM">
              <span class="spectrum-Button-label has-no-wrap
