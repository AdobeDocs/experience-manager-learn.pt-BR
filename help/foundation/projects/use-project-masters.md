...
[!DNL Master Projects] pode ser criado no [!UICONTROL Mestres] pasta em [!UICONTROL Projetos AEM]. Depois que um projeto Principal é criado, ele é exibido como uma opção ao lado dos modelos disponíveis no assistente quando novos projetos são criados.
...
## Mark [!DNL Project Masters] como Inativo
