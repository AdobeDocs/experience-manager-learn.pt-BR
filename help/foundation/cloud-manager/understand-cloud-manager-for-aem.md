---
title: Entenda o Adobe Cloud Manager
description: O Adobe Cloud Manager fornece uma solução simples, mas eficiente, que permite fácil gerenciamento, introspecções e autoatendimento de ambientes AEM.
...
# Entenda o Adobe Cloud Manager

O Adobe Cloud Manager fornece uma solução simples, mas eficiente, que permite fácil gerenciamento, introspecções e autoatendimento de ambientes AEM.
