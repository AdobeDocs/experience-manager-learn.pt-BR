...
Para permitir o armazenamento em cache de cabeçalhos CORS, adicione a seguinte configuração a todos os arquivos dispatcher.any de publicação do AEM compatíveis.
