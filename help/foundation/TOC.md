...
+ Segurança {#security}
   ...
   + [Migração de credenciais JWT para OAuth](https://experienceleague.adobe.com/pt-br/docs/experience-manager-learn/foundation/authentication/jwt-to-oauth-migration){target=_blank}
